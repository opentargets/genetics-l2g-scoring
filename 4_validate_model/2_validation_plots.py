...
def main():
    ...
    feature_name_map = {
        ...
        'sqtl_coloc_llr_max': 'sQTL coloc [max]',
        'sqtl_coloc_llr_max_neglogp': 'sQTL coloc [pval]',
        'sqtl_coloc_llr_max_nbh': 'sQTL coloc [max; nbh]',
        ...
        'sqtl_pics_clpp_max': 'sQTL PICS [max]',
        'sqtl_pics_clpp_max_neglogp': 'sQTL PICS [pval]',
        'sqtl_pics_clpp_max_nhb': 'sQTL PICS [max; nbh]',
